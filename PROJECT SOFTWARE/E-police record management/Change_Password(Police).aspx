<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Change_Password(Police).aspx.cs" Inherits="Change_Password_Police_" %>
...
<div class="col-md-3">
    ...
    <table>
    <tr>
    <td class="style1">Old Password</br></br></td>
    <td><asp:Textbox ID="Textbox1" runat="server"/><asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="Textbox1" ErrorMessage="Enter Old Password" ForeColor="Red"/></td>
    </tr>
     <tr>
    <td class="style1">New Password</br></br></td>
    <td><asp:Textbox ID="Textbox2" runat="server"/><asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="Textbox2" ErrorMessage="Enter New Password" ForeColor="Red"/></td>
    </tr>
     <tr>
    <td class="style1">Retype Password</br></br></td>
