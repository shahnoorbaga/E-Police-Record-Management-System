<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Complaint(Against).aspx.cs" Inherits="Complaint_Against_" %>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-right set-links">
                    ...
                    <li><a href="AddComplaints.aspx">ADD COMPLAINTS</a></li>
...
<div class="col-md-3">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [C_ID], [C_Des], [C_Date], [C_From], [C_Against] FROM [Complaints]">
        </asp:SqlDataSource>
    </div>
    </form>
 </div>
